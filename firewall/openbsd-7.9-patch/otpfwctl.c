/*
 * otpfwctl.c - kill switch control utility, talking to /dev/otpfw
 * directly via ioctl(); does not touch the daemon. This is the
 * day-to-day on/off switch - see README.md's "Activate"/"Deactivate"
 * and the distinction from NOTPFW (whether the hook is compiled into the
 * kernel binary at all, a rebuild+reboot decision) documented in
 * kernel/otpfwvar.h.
 *
