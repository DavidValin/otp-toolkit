/*
 * packet_codec_windows.c - Windows port of firewall/daemon/packet_codec.c.
 *
 ...
 * unmodified from firewall/daemon/ - it declares no platform-specific
 * types), so this is a drop-in replacement: the Windows service project
 * compiles this file instead of firewall/daemon/packet_codec.c.
 */
 ...
 * firewall/daemon/packet_codec.c either. */
